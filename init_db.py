...
food_items = [
    ...
    ("Rojak", "Hajitapah Mamak", 4.50, "Carbs",    250),
    ("Rojak biasa", "Hajitapah Mamak", 5.50, "Carbs",    270),
    ("Rojak telur", "Hajitapah Mamak", 5.50, "Carbs",    360),
    ("Rojak mee/mee", "Hajitapah Mamak", 5.50, "Carbs",    380),
    ("Rojak mee + telur", "Hajitapah Mamak", 5.50, "Carbs",    470),
    ...
    ("Mee Goreng Mamak", "Deen Cafe", 5.00, "Carbs", 660),
    ("Maggi Goreng", "Deen Cafe", 5.00, "Carbs", 540),
    ("Yee Mee Goreng", "Deen Cafe", 6.00, "Carbs", 570),
    ("Hokkien Mee", "Deen Cafe", 6.00, "Carbs", 610),
    ("Maggi Goreng XL", "Deen Cafe", 7.00, "Carbs", 790),
    ("Nasi Butter Chicken", "Deen Cafe", 8.00, "Carbs", 760),
    ("Nasi Butter Fish", "Deen Cafe", 8.00, "Carbs", 710),
    ...
    ("Sea Food Tom Yam Soup+Rice", "Deen Cafe", 8.00, "Carbs", 520),
    ("Campur Tom Yam Soup+Rice", "Deen Cafe", 8.50, "Carbs", 560),
    ("Maggi Soup", "Deen Cafe", 5.00, "Carbs", 390),
    ("Kuey Tiau Soup", "Deen Cafe", 5.00, "Carbs", 380),
    ("Bihun Soup", "Deen Cafe", 5.00, "Carbs", 350),
    ("Vegetarian+Nasi Soup", "Deen Cafe", 6.00, "Carbs", 430),
    ("Cendawan+Nasi Soup", "Deen Cafe", 6.00, "Carbs", 430),
    ("Ayam+Nasi Soup", "Deen Cafe", 6.00, "Carbs", 530),
    ("Daging+Nasi Soup", "Deen Cafe", 7.00, "Carbs", 560),
    ("Kambing+Nasi Soup", "Deen Cafe", 10.00, "Carbs", 620),
    ("Nasi Goreng Biasa", "Deen Cafe", 5.00, "Carbs", 510),
    ("Nasi Goreng Kampung", "Deen Cafe", 5.00, "Carbs", 560),
    ("Nasi Goreng Cina", "Deen Cafe", 5.00, "Carbs", 530),
    ...
    ("Nasi Goreng Sardin", "Deen Cafe", 6.00, "Carbs", 580),
    ("Nasi Goreng Pattaya", "Deen Cafe", 6.00, "Carbs", 680),
    ("Nasi Goreng Ikan Masin", "Deen Cafe", 6.00, "Carbs", 570),
    ("Nasi Goreng Tomato", "Deen Cafe", 6.00, "Carbs", 550),
    ("Nasi Goreng Cendawan", "Deen Cafe", 6.00, "Carbs", 540),
    ("Nasi Goreng Daging", "Deen Cafe", 7.00, "Carbs", 620),
    ("Nasi Goreng Sea Food", "Deen Cafe", 7.00, "Carbs", 610),
    ("Nasi Goreng Ayam(Chicken)", "Deen Cafe", 8.00, "Carbs", 610),
    ("Nasi Goreng Paprik Ayam", "Deen Cafe", 8.00, "Carbs", 670),
    ("Nasi Goreng Msa(Egg)", "Deen Cafe", 9.00, "Carbs", 580),
    ("Nasi Goreng Thai", "Deen Cafe", 9.00, "Carbs", 590),
    ("Nasi Goreng Kambing", "Deen Cafe", 12.00, "Carbs", 710),
    ("Carbonara Pasta Special", "Deen Cafe", 10.00, "Carbs", 660),
    ...
    ("Mee Bandung Hot Plate", "Deen Cafe", 6.00, "Carbs", 620),
    ...
    ("Nasi Ayam Kicap", "Deen Cafe", 7.00, "Carbs", 540),
    ("Nasi Ayam Black Pepper", "Deen Cafe", 7.00, "Carbs", 530),
    ("Nasi Ayam Sweet and Sour", "Deen Cafe", 7.00, "Carbs", 560),
    ("Nasi Ayam Cili Padi", "Deen Cafe", 7.00, "Carbs", 540),
    ("Nasi Daging Kunyit", "Deen Cafe", 7.50, "Carbs", 610),
    ("Nasi Daging Kicap", "Deen Cafe", 7.50, "Carbs", 580),
    ("Nasi Daging Merah", "Deen Cafe", 7.50, "Carbs", 590),
    ("Nasi Daging Black Pepper", "Deen Cafe", 7.50, "Carbs", 570),
    ("Nasi Daging Sweet and Sour", "Deen Cafe", 7.50, "Carbs", 600),
    ("Nasi Sotong Kunyit", "Deen Cafe", 7.50, "Carbs", 550),
    ("Nasi Sotong Sambal", "Deen Cafe", 7.50, "Carbs", 570),
    ("Nasi Sotong Merah", "Deen Cafe", 7.50, "Carbs", 570),
    ("Nasi Udang Kunyit", "Deen Cafe", 7.50, "Carbs", 540),
    ("Nasi Udang Sambal", "Deen Cafe", 7.50, "Carbs", 560),
    ("Nasi Udang Kicap", "Deen Cafe", 7.50, "Carbs", 550),
    ("Nasi Udang Black Pepper", "Deen Cafe", 7.50, "Carbs", 530),
    ("Nasi Sea Food Kunyit", "Deen Cafe", 7.50, "Carbs", 570),
    ("Nasi Sea Food Merah", "Deen Cafe", 7.50, "Carbs", 590),
    ("Nasi Sea Food Sweet and Sour", "Deen Cafe", 7.50, "Carbs", 590),
    ("Nasi Putih Kari Ayam", "Deen Cafe", 7.50, "Carbs", 610),
    ("Nasi Telur Bungkus", "Deen Cafe", 8.00, "Carbs", 640),
    ("Nasi Telur Bistik", "Deen Cafe", 8.00, "Carbs", 730),
    ("Teh O", "Deen Cafe", 1.00, "Beverage", 65),
    ("Teh Tarik", "Deen Cafe", 1.50, "Beverage", 140),
    ("Teh O Limau", "Deen Cafe", 1.50, "Beverage", 70),
    ("Teh O Laici", "Deen Cafe", 2.50, "Beverage", 120),
    ("Nescafe", "Deen Cafe", 2.00, "Beverage", 150),
    ("Nescafe O", "Deen Cafe", 1.50, "Beverage", 70),
    ("Neslo", "Deen Cafe", 2.50, "Beverage", 210),
    ("White Coffee", "Deen Cafe", 2.50, "Beverage", 180),
    ("Kopi", "Deen Cafe", 1.50, "Beverage", 130),
    ("Kopi O", "Deen Cafe", 1.00, "Beverage", 65),
    ("Milo", "Deen Cafe", 2.00, "Beverage", 180),
    ("Milo O", "Deen Cafe", 2.00, "Beverage", 120),
    ("Barley", "Deen Cafe", 1.50, "Beverage", 80),
    ("Horlicks", "Deen Cafe", 2.50, "Beverage", 190),
    ("Limau Panas", "Deen Cafe", 1.50, "Beverage", 60),
    ("Teh O Ais", "Deen Cafe", 1.50, "Beverage", 85),
    ("Teh Tarik Ais", "Deen Cafe", 2.00, "Beverage", 160),
    ("Teh O Limau Ais", "Deen Cafe", 2.00, "Beverage", 90),
    ("Teh O Laici Ais", "Deen Cafe", 3.00, "Beverage", 150),
    ("Nescafe Ais", "Deen Cafe", 2.50, "Beverage", 180),
    ("Nescafe O Ais", "Deen Cafe", 2.00, "Beverage", 90),
    ("Neslo Ais", "Deen Cafe", 3.00, "Beverage", 240),
    ("White Coffee Ais", "Deen Cafe", 3.00, "Beverage", 210),
    ("Kopi Ais", "Deen Cafe", 2.00, "Beverage", 160),
    ("Kopi O Ais", "Deen Cafe", 1.50, "Beverage", 85),
    ("Milo Ais", "Deen Cafe", 2.50, "Beverage", 220),
    ("Milo O Ais", "Deen Cafe", 2.50, "Beverage", 140),
    ("Barley Ais", "Deen Cafe", 2.00, "Beverage", 100),
    ("Horlicks Ais", "Deen Cafe", 3.00, "Beverage", 230),
    ("Limau Ais", "Deen Cafe", 2.00, "Beverage", 80),
    ("Laici", "Deen Cafe", 3.00, "Beverage", 160),
    ("Sirap Bandung", "Deen Cafe", 2.00, "Beverage", 150),
    ("Orange Beverage", "Deen Cafe", 4.00, "Beverage", 120),
    ("Apple Beverage", "Deen Cafe", 4.00, "Beverage", 110),
    ("Watermelon Beverage", "Deen Cafe", 4.00, "Beverage", 90),
    ("Extra Joss", "Deen Cafe", 4.00, "Beverage", 30),
    ("Carrot Beverage", "Deen Cafe", 3.50, "Beverage", 90),
]
...
# Promote the very first registered user to admin if no admin exists yet
# Gives the initial deployer access without needing a manual SQL command
...
if not existing_admin:
    ...
    if first_user:
        cur.execute("UPDATE users SET role = 'admin' WHERE id = ?", (first_user[0],))
        print(f"Promoted user id={first_user[0]} to admin (no admin existed).")
